export const metadata = { title: "Terms & Conditions | PantryLegend" };
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="container mx-auto max-w-3xl px-4 py-16">
        <div className="space-y-8">
          {[
            ["1. Acceptance of Terms", "By accessing and using PantryLegend, you accept and agree to be bound by these Terms and Conditions. If you do not agree to these terms, please do not use our website."],
            ...
            ["5. Returns and Refunds", "You have the right to cancel your order within 14 days of receipt under the Consumer Contracts Regulations. Perishable goods are exempt from this right. To initiate a return, contact us at orders@pantrylegendd.com."],
            ["6. Intellectual Property", "All content on this website, including text, graphics, logos and images, is the property of PantryLegend and is protected by UK and international copyright law."],
            ["7. Limitation of Liability", "To the maximum extent permitted by law, PantryLegend shall not be liable for any indirect, incidental, or consequential damages arising from your use of our products or website."],
