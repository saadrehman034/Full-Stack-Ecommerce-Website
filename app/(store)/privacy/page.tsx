export const metadata = { title: "Privacy Policy | Vinzlu" };
      ...
      <section className="container mx-auto max-w-3xl px-4 py-16">
        <div className="prose prose-lg max-w-none text-foreground">
          {[
            ...
            ["Your Rights", "Under GDPR and UK data protection law, you have the right to access, rectify, erase, or port your personal data. You may also object to processing or withdraw consent at any time. Contact us at privacy@vinzlu.com to exercise these rights."],
            ["Contact", "For any privacy-related questions, contact our Data Protection Officer at privacy@vinzlu.com or write to us at 12 Artisan Quarter, London, EC1A 1BB."],
          ].map(([title, body]) => (
